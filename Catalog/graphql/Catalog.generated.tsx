        ...
        models: {
          ...
          edges?: Array<{
            ...
            node?: {
              ...
              equipmentClass: { __typename?: 'EquipmentClassType'; defaultModelImage?: any | null };
            } | null;
          } | null> | null;
        };
      } | null;
...
export function useCatalogCategoriesQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<CatalogCategoriesQuery, CatalogCategoriesQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<CatalogCategoriesQuery, CatalogCategoriesQueryVariables>(
    CatalogCategoriesDocument,
    options
  );
}
export function useCatalogCategoriesLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<CatalogCategoriesQuery, CatalogCategoriesQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useLazyQuery<CatalogCategoriesQuery, CatalogCategoriesQueryVariables>(
    CatalogCategoriesDocument,
    options
  );
}
